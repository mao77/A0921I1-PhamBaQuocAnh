...
public class UserRepositoryImpl implements UserRepository {
    ...
    private static final String SEARCH_BY_COUNTRY = "select id,`name`, email, country from users where country like concat('%',?, '%');";
...
//    }
    ...
    @Override
    public List<User> searchList(String country1) {
        List<User> userList = new ArrayList<>();
        // Step 1: Establishing a Connection
        try (Connection connection = getConnection();
