...
public class Service {
    ...
    public Service(String name, int area, double cost, int maxPeople, int rentTypeId, int typeId, String standardRoom, String descriptionOtherConvenience, double poolArea, int numberOfFloors) {
        this.name = name;
        this.area = area;
        this.cost = cost;
        this.maxPeople = maxPeople;
